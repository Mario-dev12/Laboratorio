...
fs.readFile(filePath, "utf8", (err, data) => {  
	...
	const result = data  
		...
		.replace(  
			/.\/dist\/assets\/index-legacy-C0fhmGs7\.js">System.import\(document\.getElementById\('vite-legacy-entry'\)\.getAttribute\('data-src'\)\)/,  
			'<script nomodule crossorigin id="vite-legacy-entry" src="./assets/index-legacy-C0fhmGs7.js">System.import(document.getElementById(\'vite-legacy-entry\').getAttribute(\'data-src\'))</script>'  
		);  
