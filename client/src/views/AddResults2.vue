...
<script setup lang="ts">
	...
	onMounted(async () => {
		...
		for (const profile of ordersArray.value) {
			...
			const profileSection2: any = await profilesStore.fetchProfileByInputsName2(profile.profiles[0].profileName, profile.idOrder);

			console.log('lee', profileSection2)
			...
			const foundKey = Object.keys(profileSection2).find(key => 
