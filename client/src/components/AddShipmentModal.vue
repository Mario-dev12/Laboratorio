		...
		<ion-content>
			<form @submit.prevent="submit">
				...
				<div class="form-group">
					...
					<div>
						<input type="radio" id="paymentYes" :value="true" v-model="shipment.pay_done" class="radio-input" />
						<label class="radio-label" for="paymentYes">Sí</label>

						<input type="radio" id="paymentNo" :value="false" v-model="shipment.pay_done" class="radio-input" />
				...
				<div class="form-group" v-if="!shipment.pay_done">
					...
					<input v-model="shipment.pay_amount" type="text" class="form-control custom-input" placeholder="Ingrese el monto" />
				</div>
				...
				<div class="form-group">
					...
					<select v-model="shipment.idReactive" required class="form-select custom-input">
						...
						<option v-for="reactive in reactives" :key="reactive.idReactive" :value="reactive.idReactive">
							{{ reactive.name }}
						</option>
					</select>
				</div>
				...
				<div class="form-group">
					...
					<select v-model="shipment.idProvider" required class="form-select custom-input">
						...
						<option v-for="provider in providers" :key="provider.idProvider" :value="provider.idProvider">
							{{ provider.name }}
						</option>
					</select>
				</div>
